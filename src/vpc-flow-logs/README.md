...
| CustomSecret | In case you want to use SSM with your own secret that contains coralogx private key instead of creating a new secret, specify the name of the secret. |   |  | 
